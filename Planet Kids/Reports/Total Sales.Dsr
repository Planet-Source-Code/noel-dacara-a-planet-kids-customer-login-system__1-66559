VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptTotalSales 
   Caption         =   "0a"
   ClientHeight    =   7965
   ClientLeft      =   60
   ClientTop       =   345
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Company_Address"
      EndProperty
      ItemType3       =   5
      ...
      BeginProperty Item10 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Total_Sales_String"
         CanGrow         =   -1  'True
         Alignment       =   1
      EndProperty
      ItemType11      =   3
      BeginProperty Item11 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Current_DateTime"
         Alignment       =   1
      EndProperty
      ItemType12      =   5
      ...
      BeginProperty Item14 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Ave_Client_Hours"
         Alignment       =   1
      EndProperty
      ItemType15      =   3
      ...
      BeginProperty Item18 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Total_Service_Charges"
         Alignment       =   1
      EndProperty
      ItemType19      =   3
      ...
      BeginProperty Item20 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Total_Misc_Fees"
         Alignment       =   1
      EndProperty
      ItemType21      =   3
      ...
      BeginProperty Item23 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "End_Date"
      EndProperty
   EndProperty
End
Attribute VB_Name = "rptTotalSales"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
    With Me.Sections("Detail").Controls
        .Item("Company_Name").Caption = cINI.Value("Settings", "Comp_Name")
        .Item("Company_Address").Caption = cINI.Value("Settings", "Comp_Address")
        .Item("Current_DateTime").Caption = Format$(Date$, "MMMM dd, yyyy") & " " & Format$(Time$, "HH:MM AM/PM")
        
        Dim i As Integer
        Dim j As Integer
        
        Const cReportKey As String = "ReportStrings"
        
        Me.Caption = cINI.Value(cReportKey, Me.Name & "0a")
        Me.Title = cINI.Value(cReportKey, Me.Name & "0b")
        
            j = .Count
        For i = 1 To j
            If (TypeOf .Item(i) Is RptLabel) Then
                If (IsNumeric(.Item(i).Caption)) Then
                    .Item(i).Caption = cINI.Value(cReportKey, Me.Name & .Item(i).Caption)
                End If
            End If
        Next
    End With
